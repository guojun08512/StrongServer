...
const routers = router
  ...
  .put('/worktime', workTimeUpdate)
  .put('/pause/worktime', pauseWorkTimeUpdate)
  .get('/position', positionQuery)
  .post('/sign/privateLesson', SignPrivateLesson)
  .post('/sign/privateLesson/:id', SignOkPrivateLesson)
  .delete('/sign/privateLesson', CancelSignPrivateLesson)
  .get('/sign/privateLesson', querySignPrivateLesson)
  .get('/privateLesson', queryPrivateLessonInfo)
  .get('/privateLessonTime', queryCoachPrivateLessonTime)
  .post('/order', orderCoach)
  .delete('/order/:id', deleteOrderCoach)
  .get('/order', queryOrderCoach)
  .post('/order/timeSet', orderTimeSet)
  .get('/order/timeSet', orderTimeSetQuery);
